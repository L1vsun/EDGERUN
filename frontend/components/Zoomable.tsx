...
//
// Deliberately no library and no portal: a fixed overlay is a fixed overlay. Escape closes,
// the backdrop closes, and the page behind it stops scrolling while it is open - without that
// last part a trackpad scroll moves the page under the image and the overlay feels broken.
